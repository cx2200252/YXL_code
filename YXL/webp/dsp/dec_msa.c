...
#line 1 "G:/faceunity/jc/bin/win32_release/../../wrapper/webp/dsp/dec_msa.c"
...
WEBP_TSAN_IGNORE_FUNCTION void DEDUP_vP8_DspInitMSA(void) {
...
WEBP_DSP_INIT_STUB(DEDUP_vP8_DspInitMSA)
